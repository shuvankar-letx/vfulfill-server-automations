...
//$config['mongo_db']['default']['hostname'] = '3.13.249.114';
$config['mongo_db']['default']['port'] = '27017';
$config['mongo_db']['default']['username'] = 'admin';
$config['mongo_db']['default']['password'] = 'password';
$config['mongo_db']['default']['database'] = 'vfulfill';
...
// $config['mongo_db']['test']['hostname'] = '52.35.85.220';
$config['mongo_db']['test']['hostname'] = 'localhost';
$config['mongo_db']['test']['port'] = '27017';
$config['mongo_db']['test']['username'] = 'admin';
