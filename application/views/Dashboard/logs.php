                        ...
                        <div class=content-wrapper>
                                ...
                                <div class="col-md-12 grid-margin">
                                    <div class=row>
                                        <div class="mb-4 col-12 col-xl-8 mb-xl-0">
                                            <h3 class=font-weight-bold>Cron Execution Logs</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-4">
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <form method="GET" action="<?= base_url('crons/logs') ?>" class="row g-3">
                                                <div class="col-md-3">
                                                    <label class="form-label">Cron</label>
                                                    <select class="form-control" name="cron">
                                                        <option value="">All Crons</option>
                                                        <?php foreach($active_crons as $c): ?>
                                                            <option value="<?= $c->cron_id ?>" <?= $filters['cron'] == $c->cron_id ? 'selected' : '' ?>>
                                                                <?= ucwords(strtolower(str_replace("_"," ",$c->name))) ?>
                                                            </option>
                                                        <?php endforeach; ?>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <input type="text" class="form-control" name="run_id" value="<?= htmlspecialchars($filters['run_id'] ?? '') ?>" placeholder="RUN_XXX">
                                                </div>
                                                <div class="col-md-2 d-flex align-items-end">
                                                    <button type="submit" class="btn btn-primary me-2 w-50">Filter</button>
                                                    <a href="<?= base_url('crons/logs') ?>" class="btn btn-light w-50">Reset</a>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                                        ...
                                                        <?php else: ?>
                                                            <?php foreach($logs as $log): ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?= ucwords(strtolower(str_replace("_"," ",$log->cron_name))) ?></td>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            <a class="dropdown-item" href="<?= base_url('crons/log_details/'.$log->run_id) ?>"><i class="ti-info-alt"></i> View Details</a>
                                                                            <a class="dropdown-item" href="<?= base_url('crons/retry_execution/'.$log->run_id) ?>" onclick="return confirm('Are you sure you want to retry this execution?')"><i class="ti-reload"></i> Retry Execution</a>
                                                                            <a class="dropdown-item" target="_blank" href="<?= base_url('crons/view_raw_log/'.$log->run_id) ?>"><i class="ti-file"></i> View Raw Log</a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            <?php endforeach; ?>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mt-4">
                                                ...
                                                <div>Showing <?= (($page - 1) * $limit) + 1 ?> to <?= min($page * $limit, $count) ?> of <?= $count ?> entries</div>
                                                <?php if($count > $limit): ?>
                                                <nav>
